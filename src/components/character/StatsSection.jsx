...
import { STAT_TIERS as REGULAR_TIERS, CONDITIONAL_TIERS, STAT_LEVELS as LEVELS } from "@/components/gameConstants";
...
export default function StatsSection({ character, setCharacter }) {
  ...
  const calculateDicePool = (tier, level, isConditional) => {
    ...
    const isLowTier = tier === "Vermin" || tier === "Cantrip";
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        ...
        <CardContent className="space-y-2 text-sm text-slate-400">
          ...
          <p>• <span className="text-amber-400">Universal Min/Cap:</span> Below 10 dice = +1t (+2t if 5+ below); Above 25 = -1t per 5 dice (min t3, excess converts to auto successes)</p>
